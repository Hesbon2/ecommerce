    ...
    const navs = [
        {
            ...
            redirect: "https://www.SmartHouse.com/communication-preferences/push",
        },
        {
            title: "Sell on SmartHouse",
            icon: <BusinessCenterIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://seller.SmartHouse.com/sell-online",
        },
        {
        ...
        },
        {
            ...
            redirect: "https://advertising.SmartHouse.com",
        },
        {
            title: "Download App",
            icon: <DownloadIcon sx={{ fontSize: "18px" }} />,
            redirect: "https://www.SmartHouse.com/mobile-apps",
        },
    ]
